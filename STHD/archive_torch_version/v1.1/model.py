...
def prepare_constants_torch(sthd_data):
    X = sthd_data.adata.obs.shape[0]  # n of spot
    Y = sthd_data.adata.shape[1]  # n of gene (filtered )
    Z = sthd_data.lambda_cell_type_by_gene_matrix.shape[0]  # n of cell type
...
def train(
    ...
    for i in range(n_iter):
        ...
        print(f'{i:<10}{duration:<15.2f}{-ll + beta * ce:<15.4f}{ll:<15.4f}{ce:<15.4f}')
...
# @njit
# def fill_G(X, Z, P, Acsr_row, Acsr_col, G):
#     for a in range(X):
